...
class Test(TestCase):
    ...
    def test_stringVariosElementos1(self):
        self.assertEqual(Estadistica().calcular("1,2,3"), [3, 1, 3, 2], "String con tres elemento")

    def test_stringVariosElementos2(self):
        self.assertEqual(Estadistica().calcular("1,2,3,4"), [4, 1, 4, 2.5], "String con cuatro elemento")
